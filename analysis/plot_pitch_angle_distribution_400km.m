...
yy=load('/Data/ift/ift_romfys1/dsarria/TEB/simu_data_180602/simu_data_contour_fluence_alt_ang_gaussian.mat');
yy=yy.simu_data;
...
yy = yy(source.opening_angle==20 & source.alt==14 & (simu.type==11 | simu.type==-11),:);
...
pitch_angle = atan2(v_perp,v_par)*180/pi;
...
N = vertcat(interp1(centers,N,0,'linear','extrap'), N);
centers = [0 centers];
