...
namespace GeographicLib {
    ...
    public:
        ...
        field_comp get_field_BxByBz(real t, real lat, real lon, real h) const {
            real dummy;
            real Bx, By, Bz;
            Field(t, lat, lon, h, false, Bx, By, Bz, dummy, dummy, dummy);
            return field_comp{By, Bx, -Bz}; // on purpose to be the same as Bx,By,Bz fields given by fortran igrf routine
        }
        ///
