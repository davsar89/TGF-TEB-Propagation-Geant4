...
public:
     ...
     */
    DecayedException(const sgp4::DateTime &dt, const Vector &pos, const Vector &vel)
            : runtime_error("Satellite decayed"), _dt(dt), _pos(pos), _vel(vel) {
    }

    /**
     * @returns the date
     */
    sgp4::DateTime Decayed() const {
        return _dt;
    }
